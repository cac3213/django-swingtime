...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('swingtime_event', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.creator'
        db.delete_column('swingtime_event', 'creator_id')
